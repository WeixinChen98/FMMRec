...
class Config(object):
    ...
    def __init__(self, recommendation_model=None, dataset=None, config_dict=None):
        """
        Args:
        ...
        if config_dict is None:
            config_dict = {}
        config_dict['recommendation_model'] = recommendation_model
    ...
    def _load_dataset_model_config(self, config_dict):
        ...
        if config_dict['fairness_model'] is None:
            file_list.append(os.path.join(cur_dir, "model", "pretrain", "{}.yaml".format(config_dict['recommendation_model'].split('_')[0])))
        else:
            file_list.append(os.path.join(cur_dir, "model", "fairness_tuning", "{}.yaml".format(config_dict['recommendation_model'].split('_')[0])))
